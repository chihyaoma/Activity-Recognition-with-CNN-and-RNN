...
-- 
-- 
--  Use the CNN temporal network trained from UCF-101 to generate feature
--  vectors for each of the frames
-- 
-- 
--  Contact: Chih-Yao Ma at <cyma@gatech.edu>
--  This code was adapted from ./CNN-Spatial/run_UCF101_final_ResNet.lua
---------------------------------------------------------------
...
-- 				Data paths				    --
----------------------------------------------
dirModel = '/media/chih-yao/20A592BA2236E31E/FlowTraining/ResNet-34/'
dirDatabase = '/home/chih-yao/Downloads/dataset/UCF-101/FlowMap-M/'
...
op:option{'-f', '--fps', action='store', dest='fps',
          help='number of frames per second', default=9}
