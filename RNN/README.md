...
Using command line arguments or modify the code in *main.lua*, you can essentially modify the Learning rate, batch size, CUDA options, LSTI or GRU, dropout layers, and the dimension of hidden layers.
