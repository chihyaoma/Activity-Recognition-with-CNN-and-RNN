...
cmd:option('--batchSize', 512, 'number of examples per batch') -- how many examples per training 
...
cmd:option('--rho', 16, 'number of frames for each video')
cmd:option('--inputSize', 512, 'dimension of the feature vector from CNN')
...
cmd:option('-save', 'log', 'subdirectory to save/log experiments in')
