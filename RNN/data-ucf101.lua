...
if opt.spatial == true then
   ...
   assert(paths.filep(paths.concat(opt.spatFeatDir, 'data_feat_train_RGB_sp1.t7')), 'no spatial training feature file found.')
   local spaTrainFeatureLabels = torch.load(paths.concat(opt.spatFeatDir, 'data_feat_train_RGB_sp1.t7'))
   ...
   assert(paths.filep(paths.concat(opt.spatFeatDir, 'data_feat_test_RGB_sp1.t7')), 'no spatial testing feature file found.')
   local spaTestFeatureLabels = torch.load(paths.concat(opt.spatFeatDir, 'data_feat_test_RGB_sp1.t7'))
