...
cmd:text('Options:')
------------ General options --------------------
cmd:option('-pastalogName', 'LSTM-TCNN', 'the name of your experiment, e.g. pretrain-fullsize')
cmd:option('-learningRate', 1e-6, 'learning rate at t=0')
...
cmd:option('-lstmResume', '/home/chih-yao/Downloads/Models-RNN/bs48/',  'Path to directory containing checkpoint')
cmd:option('-tcnnResume', '/home/chih-yao/Downloads/Models-TCNN/1L_best-sp1/',  'Path to directory containing checkpoint')
cmd:option('-lstmOptimState',   'none',   'Path to an optimState to reload from')
cmd:option('-tcnnOptimState',   'none',   'Path to an optimState to reload from')
