...
--
--  Script to compute list of UCF-101 flow map filenames and classes
--
--  This generates a file gen/ucf101-flow.t7 which contains the list of all
--  UCF-101 training and validation flow maps and their classes. This script also
...
local function findClasses(dir)
   ...
   -- assert(#classList == 101, 'expected 101 UCF-101 classes')
