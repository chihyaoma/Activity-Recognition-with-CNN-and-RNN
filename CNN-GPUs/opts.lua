...
function M.parse(arg)
   ...
   cmd:option('-pastalogName', 'pretrain-fullsize',          'the name of your experiment, e.g. pretrain-fullsize')
   ...
   cmd:option('-downsample',      'false',  'Downsample to half of theimage size to achieve faster training for hyper-parameter optimization, only for prereset for now')
   ...
   cmd:option('-preTemporal',   'true',   'Re-trained the temporal network from initialized spatial network')
   ---------- Model options ----------------------------------
